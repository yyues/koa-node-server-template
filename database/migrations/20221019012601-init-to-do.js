...
module.exports = {
  async up( queryInterface, Sequelize ) {
    ...
    await queryInterface.createTable( 'to_do', {
      ...
      execute_time: { type: DATE, allowNull: true, defaultValue: new Date() }, // 任务的执行时间，前期可不做要求
      ...
      remind_time: { type: DATE, allowNull: true, }, // 微信的 打卡提醒时间， 可以忽略
      labels: {
        type: STRING,
        allowNull: true,
        get() {
      ...
      invite_uid: { type: INTEGER, allowNull: true }, //  邀请人 uid
      invite_time: { type: DATE, allowNull: true },// 邀请时间
